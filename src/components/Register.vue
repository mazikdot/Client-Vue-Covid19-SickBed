              ...
              <form id="example-form" method="post" name="addemp">
                <div>
                  ...
                  <h5 style="text-align: center;">
                    สมัครบัญชีผู้ใช้เพื่อเข้าใช้งาน
                  </h5>
                  <section>
                        ...
                        <div class="col m6">
                          <div class="row">
                            <div class="input-field col m4 s12">
                              <select
                                @click="fetchPrefix()"
                                v-model="select_prefix"
                              >
                                <option style="width:20px;" value=""
                                  >เลือกคำนำหน้า</option
                                >
                                <option
                                  :key="data.prefix_id"
                                  v-for="data in prefix_test"
                                  :value="data.prefix_id"
                                  >{{ data.pre_th_name }}</option
                                >
                              </select>
                            </div>
                            <div class="input-field col m4 s12">
                            ...
                            <div class="input-field col s12">
                              ...
                              <input
                                id="user_passwords_conf"
                                name="user_passwords_conf"
                                type="password"
                                v-model="user_passwords_conf"
                                autocomplete="off"
                                required
                          ...
                          <div class="row">
                            <div class="input-field col m6 s12">
                              <select @click="fetchSex()" v-model="select_sex">
                                ...
                                <option
                                  :key="data.sex_id"
                                  v-for="data in sex_data"
                                  :value="data.sex_id"
                                  >{{ data.sex_name }}</option
                                >
                              </select>
                            </div>
                            ...
                            <div class="input-field col s12">
                              ...
                              <router-link
                                class="waves-effect waves-light btn indigo2 m-b-xs"
...
export default {
  ...
  methods: {
    ...
    submitData() {
      axios
        .post("http://localhost:3000/registers", {
        ...
        .then((res) => {
          if (res.data.message == "สมัครบัญชีผู้ใช้สำเร็จ") {
            ...
            res.data.message == "โปรดลองอีกครั้งบัญชีนี้มีผู้ใช้แล้ว"
          ) {
            swal(res.data.message, "กรุณาลองอีกครั้ง", "error").then(
              function() {
