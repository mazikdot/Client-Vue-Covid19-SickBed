                      ...
                      <div class="row">
                        <div class="col m12">
                          <div class="input-field col m12 s12">
                            <h5 style="font-size: 16px;">กรอกข้อมูลเตียงผู้ป่วย</h5>
                            <input id="sick_name" name="sick_name"  v-model="sick_name" type="text" placeholder="กรอกข้อมูลเตียงผู้ป่วย" required>
                          </div>
                        </div>
                        <div class="col m12">
                          <div class="input-field col m5 s12">
                            <h5 style="font-size: 16px;">กรอกจำนวนเตียงที่ต้องการบริจาค</h5>
                        ...
                        <div class="col m12">
                          <div class="input-field col m3 s12">
                            ...
                            <input id="sick_amount"   name="sick_amount" v-model="sick_amount" type="text" placeholder="เลขที่ / หมู่ที่ " required>
                          </div>
                          <div class="input-field col m3 s12">
                          ...
                          <div class="input-field col m3 s12">
                            <h5 style="font-size: 16px;">อำเภอที่ตั้งเตียงผู้ป่วย</h5>
                          ...
                          <div class="input-field col m3 s12">
                            <h5 style="font-size: 16px;">ตำบลที่ตั้งเตียงผู้ป่วย</h5>
                        ...
                        <div class="col m12">
                          ...
                          <div class="input-field col m2 s12">
                            ...
                            <input type="button" value="บริจาคเตียง" class="waves-effect waves-light btn indigo m-b-xs" @click="submitData()">
