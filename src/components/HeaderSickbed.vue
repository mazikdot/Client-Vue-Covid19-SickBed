        ...
        <nav class="navbar navbar-inverse" role="navigation">
          ...
          <div id="main-nav" class="collapse navbar-collapse navStyle">
            <ul class="nav navbar-nav" id="mainNav">
              ...
              <li>
                <router-link class="scroll-link" to="/FormDonate"
                  >บริจาคเตียง</router-link
                >
              </li>
              <li>
                <router-link class="scroll-link" to="/SickbedWant"
                  >ต้องการเตียง</router-link
                >
              </li>
              <li>
              ...
              <li>
                <router-link class="scroll-link" to="/Myprofile"
